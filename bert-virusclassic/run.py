...
subtrain_text_df = pd.read_csv('../data/totalopcode_re.csv')
    ...
    for epoch_num in range(epochs):
        ...
        with torch.no_grad():
            ...
            for val_input, val_label in val_dataloader:
                ...
                preds = output.argmax(dim=1)  # 新增：获取预测类别
        ...
        val_recall_macro = recall_score(all_labels_val, all_preds_val, average='macro')
        val_recall_weighted = recall_score(all_labels_val, all_preds_val, average='weighted')
